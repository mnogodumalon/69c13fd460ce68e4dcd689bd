...
import { IconArrowBackUp, IconCalendarEvent, IconCar, IconFileText, IconLayoutDashboard, IconMenu2, IconSettings } from '@tabler/icons-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';
import ActionsBar from '@/components/ActionsBar';

const APP_TITLE = 'Fahrschulverwaltung';
...
const navigation = [
  ...
  { name: 'Schüler', href: '/schueler', icon: IconFileText },
  { name: 'Fahrlehrer', href: '/fahrlehrer', icon: IconFileText },
  { name: 'Fahrzeuge', href: '/fahrzeuge', icon: IconCar },
  { name: 'Prüfungstermine', href: '/pruefungstermine', icon: IconCalendarEvent },
  { name: 'Fahrstunden', href: '/fahrstunden', icon: IconFileText },
  { name: 'Schnelleintrag Fahrstunde', href: '/schnelleintrag-fahrstunde', icon: IconFileText },
];

const externalNavigation = [
  { name: 'Schüler', href: '/gateway/apps/69c13fa6471b56292ff5fcbf?template=list_page', icon: IconFileText },
  { name: 'Fahrlehrer', href: '/gateway/apps/69c13f9ad97a5dc2efe619b2?template=list_page', icon: IconFileText },
  { name: 'Fahrzeuge', href: '/gateway/apps/69c13fa5b322ab358c02384a?template=list_page', icon: IconCar },
  { name: 'Prüfungstermine', href: '/gateway/apps/69c13fa77105c5970a36e8be?template=list_page', icon: IconCalendarEvent },
  { name: 'Fahrstunden', href: '/gateway/apps/69c13fa6c91327998a2d5fb7?template=list_page', icon: IconFileText },
  { name: 'Schnelleintrag Fahrstunde', href: '/gateway/apps/69c13fa779ab3ad7b2408512?template=list_page', icon: IconFileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69c13fa6471b56292ff5fcbf?template=list_page"
